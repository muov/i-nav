...
- [uTools](https://www.u-tools.cn/) - AI 时代的轻工具平台，一个入口，无限能力
- [PixPin](https://pixpin.cn/) - 截图、录屏、OCR；一款快速灵活的工具
- [OBS](https://obsproject.com/zh-cn) - 视频录制以及直播串流软件

### 下载工具

- [clianpro](https://github.com/supzza/clianpro) - 开箱即用的网盘下载/解析解决方案 ![Windows][Windows Icon]
- [N_m3u8DL-CLI](https://github.com/nilaoda/N_m3u8DL-CLI) - m3u8 命令行下载器 ![Windows][Windows Icon]
- [Fluent M3U8](https://fluent-m3u8.org/zh/) - 美观、易用的跨平台 M3U8 下载器
- [Motrix](https://motrix.app/zh-CN) - 一款全能的下载工具
- [AB 下载管理器](https://abdownloadmanager.com/) - 下载从未这么简单
...
- [Emoji 表情大全](https://emoji6.com/emojiall/)
...
- [TinyPNG](https://tinypng.com/) - 智能AVIF、WebP、PNG和JPEG压缩
- [WebsitePlanet](https://www.websiteplanet.com/zh-hans/webtools/imagecompressor/) - 压缩PNG/JPG文件
- [RemoveBg](https://www.remove.bg/zh) - 图片背景消除
- [PIX FIX](https://zh.pixfix.com/) - 搞定含噪和质量下降的图像

### 流程画板

- [ProcessOn](https://www.processon.com/) - 在线流程图思维导图
- [boardmix](https://boardmix.cn/) - 多人协同思维导图, 流程图工具

### PDF 处理

- [PDF24 Tools](https://tools.pdf24.org/zh/) - 易于使用的在线PDF工具
...
- [微PE工具箱](https://www.wepe.com.cn/) - 超好用的装机维护工具
- [FirPE](https://firpe.cn/) - 也许是最适合年轻人使用的WinPE系统~
- [Ventoy](https://www.ventoy.net/cn/) - 制作可启动U盘的开源工具

### 系统

- [NEXT, ITELLYOU](https://next.itellyou.cn/) - 提供可靠的原版系统
- [HelloWindows](https://hellowindows.cn/) - 精校 完整 极致 Windows系统下载仓储站
- [不忘初心](https://www.pc528.net/) - 精简版系统
- [飞牛 fnOS](https://www.fnnas.com/) - 骨灰级玩家团队倾心打造的NAS系统

### 其它

- [Office Tool Plus](https://otp.landian.vip/zh-cn/) - 一款简单小巧的工具，部署并管理 Office
